...
window.FLATTENED['linux_perf_block_parser'] = true;
...
base.exportTo('tracing', function() {
  ...
  LinuxPerfBlockParser.prototype = {
	...
	ext4SyncFileEnterEvent: function(eventName, cpuNumber, pid, ts, eventBase) {
      ...
      var kthread = this.importer.getOrCreateKernelThread('ext4', pid);
	...
	blockRqIssueEvent: function(eventName, cpuNumber, pid, ts, eventBase) {
      ...
      var kthread = this.importer.getOrCreateKernelThread('block', pid);
